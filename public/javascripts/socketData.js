var socket = io.connect('http://192.168.101.45:3000');
  
socket.on('status', function (data) {

  //BUTTON BAR
  if (data["DBLIBBW1"]["Online"] == 1) {
    if (data["DBLIBBW1"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBBW1"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") {
  ...
  if (data["DBLIBBW2"]["Online"] == 1) {
    if (data["DBLIBBW2"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBBW2"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") {
  ...
  if (data["DBLIBBW3"]["Online"] == 1) {
    if (data["DBLIBBW3"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBBW3"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") {
  ...
  if (data["DBLIBCOL1"]["Online"] == 1) {
    if (data["DBLIBCOL1"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBCOL1"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") {
  ...
  if (data["DBLIBMFP1"]["Online"] == 1) {
    if (data["DBLIBMFP1"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBMFP1"]["Status"]["Scanner"]["Status"] == "Alert" || data["DBLIBMFP1"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") { //&& data["DBLIBMFP1"]["Status"]["Printer"]["Message"].indexOf("Tray 1") == 0) {
  ...
  if (data["DBLIBMFPF1"]["Online"] == 1) {
    if (data["DBLIBMFPF1"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBMFPF1"]["Status"]["Scanner"]["Status"] == "Alert" || data["DBLIBMFPF1"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") {
  ...
  if (data["DBLIBMFPSTAFF"]["Online"] == 1) {
    if (data["DBLIBMFPSTAFF"]["Status"]["Printer"]["Status"] == "Alert" || data["DBLIBMFPSTAFF"]["Status"]["Scanner"]["Status"] == "Alert" || data["DBLIBMFPSTAFF"]["Status"]["Printer"]["Status"] == "Cartridge Almost Empty") {
  ...
  if (data["DBLIBBW1"]["Online"] == 1) {
    ...
    else if (data["DBLIBBW1"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBBW1"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    $("#BW1toner").html("TONER");
    if (data["DBLIBBW1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBBW1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBBW1"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
  ...
  if (data["DBLIBBW2"]["Online"] == 1) {
    ...
    else if (data["DBLIBBW2"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBBW2"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    $("#BW2toner").html("TONER");
    if (data["DBLIBBW2"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBBW2"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBBW2"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
  ...
  if (data["DBLIBBW3"]["Online"] == 1) {
    ...
    else if (data["DBLIBBW3"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBBW3"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    $("#BW3toner").html("TONER");
    if (data["DBLIBBW3"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
      $("#BW3toB").html('<p class="text-warning">&nbsp<strong>Black</strong>: ' + data["DBLIBBW3"]["Supplies"]["Toner"]["Black"]["Status"]);
    }
    else if (data["DBLIBBW3"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBBW3"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
  ...
  if (data["DBLIBCOL1"]["Online"] == 1) {
    ...
    else if (data["DBLIBCOL1"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBCOL1"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    if (data["DBLIBCOL1"]["Supplies"]["Other"]["Intermediate_Transfer_Unit"]["Status"] == "Replace Soon") {
    	$("#COL1transferUnit").html('&nbsp<strong>Intermediate Transfer Roller</strong>: <p class="text-warning">' + data["DBLIBCOL1"]["Supplies"]["Other"]["Intermediate_Transfer_Unit"]["Status"] + ' (' + data["DBLIBCOL1"]["Supplies"]["Other"]["Intermediate_Transfer_Unit"]["Level"] + '%)</p>');
    }
    else {
    ...
    if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBCOL1"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
    ...
    if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Magenta"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Magenta"]["Status"] == "Cartridge Empty" || data["DBLIBCOL1"]["Supplies"]["Toner"]["Magenta"]["Status"] == "Error") {
    ...
    if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Cyan"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Cyan"]["Status"] == "Cartridge Empty" || data["DBLIBCOL1"]["Supplies"]["Toner"]["Cyan"]["Status"] == "Error") {
    ...
    if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Yellow"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBCOL1"]["Supplies"]["Toner"]["Yellow"]["Status"] == "Cartridge Empty" || data["DBLIBCOL1"]["Supplies"]["Toner"]["Yellow"]["Status"] == "Error") {
  ...
  if (data["DBLIBMFP1"]["Online"] == 1) {
    ...
    else if (data["DBLIBMFP1"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBMFP1"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFP1"]["Status"]["Copier"]["Status"] == "Printing..." || data["DBLIBMFP1"]["Status"]["Copier"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFP1"]["Status"]["Scanner"]["Status"] == "Printing..." || data["DBLIBMFP1"]["Status"]["Scanner"]["Status"] == "Busy") {
    ...
    if (data["DBLIBMFP1"]["Status"]["Scanner"]["Status"] == "Alert" || data["DBLIBMFP1"]["Status"]["Scanner"]["Status"] == "Cover Open") {
    ...
    if (data["DBLIBMFP1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
      $("#MFP1toB").html('<p class="text-warning">&nbsp<strong>Black</strong>: ' + data["DBLIBMFP1"]["Supplies"]["Toner"]["Black"]["Status"]);
    }
    else if (data["DBLIBMFP1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBMFP1"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
  ...
  if (data["DBLIBMFPF1"]["Online"] == 1) {
    ...
    else if (data["DBLIBMFPF1"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBMFPF1"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFPF1"]["Status"]["Copier"]["Status"] == "Printing..." || data["DBLIBMFPF1"]["Status"]["Copier"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFPF1"]["Status"]["Scanner"]["Status"] == "Printing..." || data["DBLIBMFPF1"]["Status"]["Scanner"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFPF1"]["Status"]["Fax"]["Status"] == "Printing..." || data["DBLIBMFPF1"]["Status"]["Fax"]["Status"] == "Busy") {
    ...
    if (data["DBLIBMFPF1"]["Status"]["Scanner"]["Status"] == "Alert" || data["DBLIBMFPF1"]["Status"]["Scanner"]["Status"] == "Cover Open") {
    ...
    if (data["DBLIBMFPF1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
      $("#MFPF1toB").html('<p class="text-warning">&nbsp<strong>Black</strong>: ' + data["DBLIBMFPF1"]["Supplies"]["Toner"]["Black"]["Status"]);
    }
    else if (data["DBLIBMFPF1"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBMFPF1"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
  ...
  if (data["DBLIBMFPSTAFF"]["Online"] == 1) {
    ...
    else if (data["DBLIBMFPSTAFF"]["Status"]["Printer"]["Status"] == "Printing..." || data["DBLIBMFPSTAFF"]["Status"]["Printer"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Status"]["Copier"]["Status"] == "Printing..." || data["DBLIBMFPSTAFF"]["Status"]["Copier"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Status"]["Scanner"]["Status"] == "Printing..." || data["DBLIBMFPSTAFF"]["Status"]["Scanner"]["Status"] == "Busy") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Status"]["Fax"]["Status"] == "Printing..." || data["DBLIBMFPSTAFF"]["Status"]["Fax"]["Status"] == "Busy") {
    ...
    if (data["DBLIBMFPSTAFF"]["Status"]["Scanner"]["Status"] == "Alert" || data["DBLIBMFPSTAFF"]["Status"]["Scanner"]["Status"] == "Cover Open") {
    ...
    if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Black"]["Status"] == "Cartridge Empty" || data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Black"]["Status"] == "Error") {
    ...
    if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Magenta"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Magenta"]["Status"] == "Cartridge Empty" || data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Magenta"]["Status"] == "Error") {
    ...
    if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Cyan"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Cyan"]["Status"] == "Cartridge Empty" || data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Cyan"]["Status"] == "Error") {
    ...
    if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Yellow"]["Status"] == "Cartridge Almost Empty") {
    ...
    else if (data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Yellow"]["Status"] == "Cartridge Empty" || data["DBLIBMFPSTAFF"]["Supplies"]["Toner"]["Yellow"]["Status"] == "Error") {
